<?php
	...
	define('PAYTM_MERCHANT_MID', ' MWzdEF29169277642790'); //Change this constant's value with MID (Merchant ID) received from Paytm.
	...
	define('CALLBACK_URL', 'http://localhost/houseton/pay_response.php'); 
