...
<body class="bg-light">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-12 text-center mt-5">
        <a href="rooms.php" class="btn btn-sm btn-outline-dark rounded-0 text-white fw-bold shadow-none custom-bg" >More Rooms >>></a>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
      ...
      <div class="col-lg-12 text-center mt-5">
        <a href="facilities.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none custom-bg text-white">More Facilities >>></a>
      </div>
    </div>
  </div>
  ...
  <div class="container mt-5">
    ...
    <div class="col-lg-12 text-center mt-5">
      <a href="about.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none custom-bg text-white">Know More >>></a>
    </div>
  </div>

  <!-- Reach us -->

  <h2 class="mt-5 pt-4 mb-4 text-center fw-bold h-font" style="color: #F5385D;">REACH US</h2>
